...
public class GautiPDFAtaskaita {
	...
	public static void lentelesPavidalu(String dataNuo, String dataIki, java.io.OutputStream out)
		...
		if (PatikrintiDuArgumentus.arVisiUzpildyti(dataNuo, dataIki)) {
			...
			for (int i = 0; i < gedimai.gautiNepaskirtusPagalLaikotarpi(dataNuo, dataIki).size(); i++) {
				...
				table.addCell(new Paragraph(
						gedimai.gautiNepaskirtusPagalLaikotarpi(dataNuo, dataIki).get(i).getAprasymas(), cellFont));
				table.addCell(new Paragraph(
