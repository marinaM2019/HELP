...
//
// paragraph.add(new Phrase("MANO REGISTRUOTŲ GEDIMŲ SĄRAŠAS".toUpperCase(),
// fontBold));
...
//// String sqlPr = "SELECT iraso_data, tema, aprasymas, statusas, vykdytojas,
// vykdytojo_iraso_data FROM gedimai WHERE gedima_pateike='"
